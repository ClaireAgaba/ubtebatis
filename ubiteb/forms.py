...
class addAlumnus(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['exam_center'].choices = get_centers_from_csv('ubiteb/csv/examCenters.csv')
        self.fields['program'].choices = get_programs_from_csv('ubiteb/csv/programs.csv')
        self.fields['district'].choices = get_districts_from_csv('ubiteb/csv/districts.csv')
