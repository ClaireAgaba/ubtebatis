...
class Alumni(models.Model):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._meta.get_field('exam_center').choices = get_centers_from_csv('ubiteb/csv/examCenters.csv')
     
        
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._meta.get_field('district').choices = get_districts_from_csv('ubiteb/csv/districts.csv')
    
    
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._meta.get_field('program').choices = get_programs_from_csv('ubiteb/csv/programs.csv')
